...
class Showing() : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<Showing> {
        override fun createFromParcel(parcel: Parcel): Showing {
            return Showing(parcel)
        }

        override fun newArray(size: Int): Array<Showing?> {
